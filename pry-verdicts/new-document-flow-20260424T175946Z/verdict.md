...
pry_spec_version: 1
started_at: 2026-04-24T17:59:46Z
finished_at: 2026-04-24T17:59:47Z
---
...
## Step 8 — `assert_state DocumentListVM.documents.count equals 3`
...
- `/Users/Dom/Projects/NeimadWorks/pry/pry-verdicts/new-document-flow-20260424T175946Z/step-8-failure.png`


## Preceding steps

- ✅ Step 1 — `launch` (272ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (92ms)
...
- ✅ Step 5 — `click { id: "new_doc_button" }` (213ms)
- ✅ Step 6 — `click { id: "new_doc_button" }` (77ms)
- ✅ Step 7 — `click { id: "new_doc_button" }` (58ms)
- ❌ Step 8 — `assert_state DocumentListVM.documents.count equals 3` (0ms) — expected DocumentListVM.documents.count equals 3; observed got 2
