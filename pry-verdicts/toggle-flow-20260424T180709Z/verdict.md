...
pry_spec_version: 1
started_at: 2026-04-24T18:07:09Z
finished_at: 2026-04-24T18:07:10Z
---

# Verdict — toggle-flow

**Status: PASSED** (10/10 steps, 992ms)

- ✅ Step 1 — `launch` (273ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (117ms)
...
- ✅ Step 7 — `click { id: "verbose_toggle" }` (82ms)
