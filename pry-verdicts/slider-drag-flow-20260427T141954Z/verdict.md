...
pry_spec_version: 1
started_at: 2026-04-27T14:19:54Z
finished_at: 2026-04-27T14:19:55Z
---

# Verdict — slider-drag-flow

**Status: PASSED** (6/6 steps, 940ms)

- ✅ Step 1 — `launch` (218ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (318ms)
- ✅ Step 3 — `assert_state DocumentListVM.intensity equals 0` (0ms)
- ✅ Step 4 — `drag from { id: "intensity_slider" } to { id: "intensity_label" }` (348ms)
