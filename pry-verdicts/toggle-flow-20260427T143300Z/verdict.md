...
pry_spec_version: 1
started_at: 2026-04-27T14:33:00Z
finished_at: 2026-04-27T14:33:01Z
---

# Verdict — toggle-flow

**Status: PASSED** (10/10 steps, 909ms)

- ✅ Step 1 — `launch` (217ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (84ms)
- ✅ Step 3 — `assert_state DocumentListVM.verbose equals false` (0ms)
- ✅ Step 4 — `click { id: "verbose_toggle" }` (152ms)
