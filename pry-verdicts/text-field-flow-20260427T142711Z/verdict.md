...
pry_spec_version: 1
started_at: 2026-04-27T14:27:11Z
finished_at: 2026-04-27T14:27:12Z
---
...
- ✅ Step 1 — `launch` (218ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (115ms)
- ✅ Step 3 — `assert_state DocumentListVM.draftName equals ""` (0ms)
- ✅ Step 4 — `click { id: "doc_name_field" }` (148ms)
- ✅ Step 5 — `sleep 0.1s` (101ms)
- ✅ Step 6 — `type "Ma composition"` (1ms)
- ✅ Step 7 — `sleep 0.1s` (104ms)
- ✅ Step 8 — `assert_state DocumentListVM.draftName equals "Ma composition"` (7ms)
