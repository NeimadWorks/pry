...
pry_spec_version: 1
started_at: 2026-04-27T14:55:34Z
finished_at: 2026-04-27T14:55:35Z
---

# Verdict — pasteboard-and-keys

**Status: PASSED** (12/12 steps, 888ms)

- ✅ Step 1 — `launch` (276ms)
- ✅ Step 2 — `wait_for (timeout 5.0s): window title_matches="DemoApp"` (104ms)
- ✅ Step 3 — `write_pasteboard "Pasted from harness"` (1ms)
- ✅ Step 4 — `click { id: "doc_name_field" }` (158ms)
- ✅ Step 5 — `sleep 0.1s` (107ms)
- ✅ Step 6 — `paste` (0ms)
- ✅ Step 7 — `wait_for (timeout 1.0s): DocumentListVM.draftName equals "Pasted from harness"` (81ms)
